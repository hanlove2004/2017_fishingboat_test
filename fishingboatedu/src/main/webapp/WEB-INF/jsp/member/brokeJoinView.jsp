		...
		<div id="content">
			...
			<div id="join" align="center">
				...
				<div class="well well-lg" align="center" style="margin: auto; height: 100%; width: 50%; background-color: #E5F1B5; box-shadow: 0 0 10px gray inset, 0 0 10px black">
					...
					<button type="submit" class="btn btn-warning" name="cancle" id="cancle" onclick="javascript:$(location).attr('href','<c:url value='/main/openBrokeMainView.do' />');">취소</button>
				</div>
			</div>
			<br />
			<br />
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#usrid").keyup(function() {
				...
				$.ajax({
					type : "post",
					url : "<c:url value='/member/selectBrokeIdCheck.do' />",
					data : "usrid=" + usrid,
			...
			$('#check').click(function() {
				...
				console.log("usrpw			: " + usrpw);
				console.log("usrpw2			: " + usrpw2);
				console.log("name			: " + name);
				console.log("phone_select	: " + phone_select);
				...
				if (re_id.test(usrid) != true) { // 아이디 검사
					...
					$.ajax({
						url : "<c:url value='/member/insertBrokeJoin.do' />",
						type : "POST",
						...
						success : function(data, status) {
							...
							if (data != null || data != undefined) {
								...
								var url = "<c:url value='/main/openBrokeMainView.do' />"; 
